			...
			<table class="items_field">
				<tr>
					<td class="item_slot"><a href="desk1.jsp"><img
							src="image/desk/desk1.png" width="100%" height="100%" /> <br>
							책상 1 </a><br> 39,800원</td>
					<td class="item_slot"><a href="desk2.jsp"><img
							src="image/desk/desk2.png" width="100%" height="100%" /> <br>
							책상 2 </a><br> 49,800원</td>
					<td class="item_slot"><a href="desk3.jsp"><img
							src="image/desk/desk3.png" width="100%" height="100%" /> <br>
							책상 3 </a><br> 59,800원</td>
					<td class="item_slot"><a href="desk4.jsp"><img
							src="image/desk/desk4.png" width="100%" height="100%" /> <br>
