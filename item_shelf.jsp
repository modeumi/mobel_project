			...
			<table class="items_field">
				<tr>
					<td class="item_slot"><a href="shelf1.jsp"><img
							src="image/shelf/shelf1.png" width="100%" height="100%" /> <br> 책상
							1 </a><br> 39,800원</td>
					<td class="item_slot"><a href="shelf2.jsp"><img
							src="image/shelf/shelf2.png" width="100%" height="100%" /> <br> 책상
							2 </a><br> 49,800원</td>
					<td class="item_slot"><a href="shelf3.jsp"><img
							src="image/shelf/shelf3.png" width="100%" height="100%" /> <br> 책상
							3 </a><br> 59,800원</td>
					<td class="item_slot"><a href="shelf4.jsp"><img
							src="image/shelf/shelf4.png" width="100%" height="100%" /> <br> 책상
							4 </a><br> 69,800원</td>
				</tr>
			</table>
			<div id="cut_line"></div>
